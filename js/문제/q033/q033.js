...
window.onload = function(){
    ...
    divRpcImgVs = document.getElementById("rpc_vs");
...
function rpcInputButtonClick(){
    ...
    switch(userRpc){
        case "가위":
            divRpcImgUser.innerHTML = "<img src='player_1.jpg'>"
            break;
        case "바위":
            divRpcImgUser.innerHTML = "<img src='player_2.jpg'>"
            break;
        case "보":
            divRpcImgUser.innerHTML = "<img src='player_3.jpg'>"
            break;
    }
    switch(comRpc){
        case "가위":
            divRpcImgCom.innerHTML = "　　　　<img src='com_1.jpg'>"
            break;
        case "바위":
            divRpcImgCom.innerHTML = "　　　　<img src='com_2.jpg'>"
            break;
        case "보":
            divRpcImgCom.innerHTML = "　　　　<img src='com_3.jpg'>"
            break;
    }
    if (userRpc==comRpc){
        divRpcImgVs.innerHTML = "<img src='비김1.jpg'>"
    }
    if (userRpc == "가위"){
        if (comRpc == "바위"){
          divRpcImgVs.innerHTML = ("<img class='dice' src='패배1.jpg'>");
        }else if (comRpc == "보"){
          divRpcImgVs.innerHTML = ("<img class='dice' src='승리1.jpg'>");
        }
      }
      if (userRpc == "바위"){
        if (comRpc == "보"){
